          ...
          {(activeCategory === 'all' || activeCategory === 'video') && (
            <>
              {[1, 2, 3, 4].map((i) => (
                <div
                  key={`video-${i}`}
                  className="card-elevated aspect-video flex flex-col items-center justify-center gap-4 border-2 border-dashed border-border"
                >
          ...
          {(activeCategory === 'all' || activeCategory === 'design') && (
            <>
              {[1, 2, 3, 4, 5, 6].map((i) => (
                <div
                  key={`design-${i}`}
                  className="card-elevated aspect-square flex flex-col items-center justify-center gap-4 border-2 border-dashed border-border"
                >
          ...
          {(activeCategory === 'all' || activeCategory === 'writing') && (
            <>
              {[1, 2, 3].map((i) => (
                <div
                  key={`writing-${i}`}
                  className="card-elevated aspect-[4/3] flex flex-col items-center justify-center gap-4 border-2 border-dashed border-border"
                >
